...
export function mapBackendOrderToAdminOrderDetails(order: any): AdminOrderDetails {
  ...
  return {
    ...
    payment: {
      ...
      provider: order.paymentProvider || "PhonePe",
      status: order.paymentStatus,
      merchantTransactionId: order.merchantTransactionId || undefined,
      phonepeTransactionId: order.phonepeTransactionId || undefined,
      paymentReference: order.paymentReference || undefined,
      paymentCompletedAt: order.paymentCompletedAt ? new Date(order.paymentCompletedAt).toLocaleString("en-IN") : undefined,
      paymentResponse: order.paymentResponse || undefined,
