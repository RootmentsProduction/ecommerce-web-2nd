...
export const adminOrdersDetailFixture: Record<string, AdminOrderDetails> = {
  "ORD-1234": {
    ...
    payment: {
      ...
      provider: "PhonePe",
      status: "Captured",
      merchantTransactionId: "TXN-1721799200000-ORD-1234",
      phonepeTransactionId: "T26072314162400001",
      paymentReference: "UTR8493021849",
      paymentCompletedAt: "24 Jun 2026 11:28 AM",
      subtotal: "₹2,27,670",
      shipping: "₹0 (Free)",
      tax: "₹6,830 (GST 3%)",
      discount: "₹0",
    ...
    timeline: [
      ...
      { title: "Payment Confirmed", description: "PhonePe payment verified & captured", date: "24 Jun 2026 11:28 AM", status: "completed" },
  ...
  "ORD-5678": {
    ...
    payment: {
      ...
      provider: "PhonePe",
      status: "Initiated",
      merchantTransactionId: "TXN-1721799200000-ORD-5678",
