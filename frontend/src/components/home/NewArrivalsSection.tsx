...
export default function NewArrivalsSection({ products: newArrivals }: NewArrivalsSectionProps) {
  ...
  // Duplicate items twice to ensure 100% continuous infinite loop
  const marqueeItems = [...newArrivals, ...newArrivals, ...newArrivals, ...newArrivals];
  ...
  return (
    <section className="py-12 sm:py-16 bg-white relative overflow-hidden">
      <div className="w-full px-[6.5%] mx-auto max-w-none relative z-10">
        ...
        {/* Section Header */}
        <div className="flex items-baseline justify-between mb-8 pb-1">
