...
export default function ProductBasicInfoSection({ errors, formData, onChange }: ProductBasicInfoProps) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div className="flex flex-col space-y-1.5">
          ...
          <select
            ...
            className={`px-3 py-2 border rounded text-xs bg-white outline-none focus:border-[#C99213] transition-all text-neutral-850 ${
