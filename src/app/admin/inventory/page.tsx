      ...
      <div className="flex-1 p-6 md:p-8 space-y-6 max-w-7xl w-full mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex items-center space-x-3 self-start sm:self-auto">
            ...
            <Link href="/admin/inventory/SKU-OO1/adjust" className="flex items-center space-x-2 px-5 py-2.5 bg-neutral-950 hover:bg-neutral-850 text-white rounded-full text-xs font-semibold tracking-wide transition-colors cursor-pointer">
                ...
                {filteredItems.map((item, idx) => {
                  ...
                  return (
                    <tr key={idx} className="hover:bg-neutral-50/50 transition-colors">
                      ...
                      {/* Action */}
                      <td className="py-4 px-6">
                        <Link href={`/admin/inventory/${urlId}/adjust`} className="text-xs font-bold text-[#C99213] hover:text-[#a9831e] flex items-center space-x-1 hover:underline cursor-pointer bg-transparent border-none p-0">
                          <span>Adjust</span>
